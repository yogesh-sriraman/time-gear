...
////// Emissive:
                ...
                float3 emissive = (((node_5523.rgb*_SecondaryTextureIntensity)+(node_6403.rgb*node_143.rgb))*i.vertexColor.rgb*i.vertexColor.a);
                ...
                fixed4 finalRGBA = fixed4(finalColor,(node_143.r*(node_1169.r+node_1169.g+node_1169.b)*i.vertexColor.a));

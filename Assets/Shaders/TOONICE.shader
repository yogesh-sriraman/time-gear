...
#pragma lighting ToonRamp
    ...
    void surf(Input IN, inout SurfaceOutput o) {
        ...
        float softRim = .5 - saturate(dot(normalize(IN.viewDir), o.Normal));// calculate a soft fresnel based on the view direction and the normals of the object
        ...
        float innerRim = .5 + saturate(dot(normalize(IN.viewDir), o.Normal)); // softer inner rim
